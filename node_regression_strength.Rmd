...
results <- data.frame(rho=numeric(), correlation=numeric(), pval=numeric(), samples=numeric(), num_nodes=numeric(), pearson_r=numeric(), network_density=numeric())
...
for (net_id in 1:1000) {
  ...
  for (i in 1:num_repeats) {
    ...
    results[nrow(results) + 1, ] <- c(rho, correlation, pval, s, n, r, p)
  }
